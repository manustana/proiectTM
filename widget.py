...
class Widget(QWidget):
    ...
    def initUI(self):
        ...
        self.grayButton = QPushButton('Grayscale', self)
        ...
        self.cropButton.setIcon(QIcon.fromTheme('edit-cut'))
        self.grayButton.setIcon(QIcon.fromTheme('image-filter-grayscale'))
        self.save_button.setIcon(QIcon.fromTheme('document-save'))
        self.zoom_in_button.setIcon(QIcon.fromTheme('zoom-in'))
        self.drawButton.setIcon(QIcon.fromTheme('preferences-desktop-theme'))
        ...
        toolbar_layout.addWidget(self.newButton)
        toolbar_layout.addWidget(self.cropButton)
        toolbar_layout.addWidget(self.grayButton)
        toolbar_layout.addWidget(self.drawButton)
        ...
        self.newButton.clicked.connect(self.newImage)
        self.cropButton.clicked.connect(self.cropImage)
        self.grayButton.clicked.connect(self.grayscaleImage)
        self.drawButton.clicked.connect(self.drawLine)
